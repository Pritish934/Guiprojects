...
Label(f,text="Login To Continue",font="SegoeUI 18 bold",pady=10,bg="skyblue").pack()
f.pack()

f=Frame(root,bg="skyblue")
Label(f,text="Username",font="SegoeUI 14 bold",pady=5,bg="skyblue").pack()
e1=Entry(f,textvariable=uname,font="SegoeUI 14 bold",borderwidth=5,relief=SUNKEN).pack(padx=5,pady=5)
Label(f,text="Password",font="SegoeUI 14 bold",pady=5,bg="skyblue").pack()
e2=Entry(f,textvariable=pwd,font="SegoeUI 14 bold",borderwidth=5,relief=SUNKEN).pack(padx=5,pady=5)
l1=Label(f,text="Conform-Password",font="SegoeUI 14 bold",pady=5,bg="skyblue").pack()
...
f=Frame(root,bg="skyblue")
Label(f,text="Don't Have An Account Then Sign-Up",font="SegoeUI 14 bold",pady=5,bg="skyblue").pack()
f.pack()
